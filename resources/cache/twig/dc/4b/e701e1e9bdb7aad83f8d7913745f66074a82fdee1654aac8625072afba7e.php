...
class __TwigTemplate_dc4be701e1e9bdb7aad83f8d7913745f66074a82fdee1654aac8625072afba7e extends Twig_Template
{
    ...
    public function block_head($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getContext($context, "collector"), "hasexception")) {
            ...
            ";
            // line 6
            echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_profiler_exception_css", array("token" => $this->getContext($context, "token"))));
            echo "
        </style>
    ";
        }
...
";
    ...
    ";
            ...
            ";
            // line 33
            echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_profiler_exception", array("token" => $this->getContext($context, "token"))));
            echo "
        </div>
    ";
        }
