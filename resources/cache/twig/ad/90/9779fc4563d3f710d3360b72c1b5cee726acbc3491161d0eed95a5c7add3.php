...
class __TwigTemplate_ad909779fc4563d3f710d3360b72c1b5cee726acbc3491161d0eed95a5c7add3 extends Twig_Template
{
    ...
    ";
        // line 5
        echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_wdt", array("token" => $this->getContext($context, "token"), "position" => "normal")));
        echo "
    ...
    <div id=\"content\">
        ...
        // line 56
        echo "                    ";
        echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_profiler_search_bar"));
        echo "
                    ";
        // line 57
